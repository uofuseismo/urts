...
std::unique_ptr<URTS::Earthworm::WaveRing>
                                  ...
                                  const bool flushRing = true)
{
    ...
    auto earthwormWaveRing
        = std::make_unique<URTS::Earthworm::WaveRing> (logger);
...
public:
    ...
    BroadcastPackets(
        ...
        std::unique_ptr<URTS::ProxyBroadcasts::DataPacket::Publisher>
             &&packetPublisher,
        std::unique_ptr<URTS::Earthworm::WaveRing> &&waveRing,
        std::shared_ptr<UMPS::Logging::ILog> &logger) :
    ...
    std::unique_ptr<URTS::Earthworm::WaveRing> mWaveRing{nullptr};
...
int main(int argc, char *argv[])
{
    ...
    try
    {
        ...
        URTS::ProxyBroadcasts::DataPacket::PublisherOptions
            packetPublisherOptions;
        auto packetPublisher
             = std::make_unique<URTS::ProxyBroadcasts::DataPacket::Publisher>
               (context, logger);
