...
#define MESSAGE_TYPE "URTS::Earthworm::TraceBuf2"
...
/// To datapacket
template<class T>
URTS::Generic::MessageFormats::DataPacket TraceBuf2<T>::toDataPacket() const
{
    URTS::Generic::MessageFormats::DataPacket dataPacket;
...
/// Swap 
void URTS::Earthworm::swap(TraceBuf2<double> &lhs,
                           TraceBuf2<double> &rhs)
{
    std::swap(lhs.pImpl, rhs.pImpl);
}

void URTS::Earthworm::swap(TraceBuf2<float> &lhs,
                           TraceBuf2<float> &rhs)
{
    std::swap(lhs.pImpl, rhs.pImpl);
}

void URTS::Earthworm::swap(TraceBuf2<int> &lhs,
                           TraceBuf2<int> &rhs)
{
    std::swap(lhs.pImpl, rhs.pImpl);
}

void URTS::Earthworm::swap(TraceBuf2<int16_t> &lhs,
...
///--------------------------------------------------------------------------///
template class URTS::Earthworm::TraceBuf2<double>;
template class URTS::Earthworm::TraceBuf2<float>;
template class URTS::Earthworm::TraceBuf2<int>;
template class URTS::Earthworm::TraceBuf2<int16_t>;

template void URTS::Earthworm::TraceBuf2<double>::setData(const std::vector<double> &);
template void URTS::Earthworm::TraceBuf2<double>::setData(const std::vector<float> &);
template void URTS::Earthworm::TraceBuf2<double>::setData(const std::vector<int> &);
template void URTS::Earthworm::TraceBuf2<double>::setData(const std::vector<int8_t> &);
template void URTS::Earthworm::TraceBuf2<double>::setData(int nSamples, const double *);
template void URTS::Earthworm::TraceBuf2<double>::setData(int nSamples, const float *);
template void URTS::Earthworm::TraceBuf2<double>::setData(int nSamples, const int *);
template void URTS::Earthworm::TraceBuf2<double>::setData(int nSamples, const int16_t *);

template void URTS::Earthworm::TraceBuf2<float>::setData(const std::vector<double> &);
template void URTS::Earthworm::TraceBuf2<float>::setData(const std::vector<float> &);
template void URTS::Earthworm::TraceBuf2<float>::setData(const std::vector<int> &);
template void URTS::Earthworm::TraceBuf2<float>::setData(const std::vector<int8_t> &);
template void URTS::Earthworm::TraceBuf2<float>::setData(int nSamples, const double *);
template void URTS::Earthworm::TraceBuf2<float>::setData(int nSamples, const float *);
template void URTS::Earthworm::TraceBuf2<float>::setData(int nSamples, const int *);
template void URTS::Earthworm::TraceBuf2<float>::setData(int nSamples, const int16_t *);

template void URTS::Earthworm::TraceBuf2<int>::setData(const std::vector<double> &);
template void URTS::Earthworm::TraceBuf2<int>::setData(const std::vector<float> &);
template void URTS::Earthworm::TraceBuf2<int>::setData(const std::vector<int> &);
template void URTS::Earthworm::TraceBuf2<int>::setData(const std::vector<int8_t> &);
template void URTS::Earthworm::TraceBuf2<int>::setData(int nSamples, const double *);
template void URTS::Earthworm::TraceBuf2<int>::setData(int nSamples, const float *);
template void URTS::Earthworm::TraceBuf2<int>::setData(int nSamples, const int *);
template void URTS::Earthworm::TraceBuf2<int>::setData(int nSamples, const int16_t *);

template void URTS::Earthworm::TraceBuf2<int16_t>::setData(const std::vector<double> &);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(const std::vector<float> &);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(const std::vector<int> &);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(const std::vector<int8_t> &);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(int nSamples, const double *);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(int nSamples, const float *);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(int nSamples, const int *);
template void URTS::Earthworm::TraceBuf2<int16_t>::setData(int nSamples, const int16_t *);
