...
#define MESSAGE_TYPE "URTS::Generic::MessageFormats::DataPacket"
#define MESSAGE_VERSION "1.0.0"

using namespace URTS::Generic::MessageFormats;
...
///--------------------------------------------------------------------------///
template void URTS::Generic::MessageFormats::DataPacket::setData(const std::vector<double> &) noexcept;
