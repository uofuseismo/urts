...
#define MESSAGE_TYPE "URTS::Services::Scalable::PacketCache::SensorResponse"
...
SensorResponse objectToSensorResponse(const nlohmann::json &obj)
{
    ...
    response.setReturnCode(static_cast<SensorResponse::ReturnCode>
...
SensorResponse::ReturnCode SensorResponse::getReturnCode() const noexcept
{
