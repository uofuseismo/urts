...
#define MESSAGE_TYPE "URTS::Services::Standalone::Incrementer::IncrementResponse"
...
IncrementResponse objectToResponse(const nlohmann::json &obj)
{
    ...
    auto code = static_cast<IncrementResponse::ReturnCode>
...
/// Return code
void IncrementResponse::setReturnCode(
    const IncrementResponse::ReturnCode code) noexcept
{
    pImpl->mCode = code;
}

IncrementResponse::ReturnCode IncrementResponse::getReturnCode() const noexcept
{
    return pImpl->mCode;
}
