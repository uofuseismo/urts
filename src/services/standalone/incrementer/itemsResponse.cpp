...
#define MESSAGE_TYPE "URTS::Services::Standalone::Incrementer::ItemsResponse"
...
ItemsResponse objectToResponse(const nlohmann::json &obj)
{
    ...
    auto code = static_cast<ItemsResponse::ReturnCode>
...
/// Return code
void ItemsResponse::setReturnCode(const ItemsResponse::ReturnCode code) noexcept
{
    pImpl->mCode = code;
}

ItemsResponse::ReturnCode ItemsResponse::getReturnCode() const noexcept
{
    return pImpl->mCode;
}
