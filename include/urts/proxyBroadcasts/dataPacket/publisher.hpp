#ifndef URTS_PROXY_BROADCASTS_DATAPACKET_PUBLISHER_HPP
#define URTS_PROXY_BROADCASTS_DATAPACKET_PUBLISHER_HPP
#include <memory>
...
{
/// @class Publisher "publisher.hpp" "urts/proxyBroadcasts/dataPacket/publisher.hpp"
