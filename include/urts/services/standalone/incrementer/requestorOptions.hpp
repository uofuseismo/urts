#ifndef UMPS_SERVICES_STANDALONE_INCREMENTER_REQUESTOR_OPTIONS_HPP
#define UMPS_SERVICES_STANDALONE_INCREMENTER_REQUESTOR_OPTIONS_HPP
#include <memory>
#include <chrono>
...
{
/// @class RequestorOptions "requestorOptions.hpp" "urts/services/standalone/incrementer/requestorOptions.hpp"
...
public:
    ...
    /// @result The receive timeout.  The default is -1.
    ...
    /// @result The receive timeout.  The default is 0.
