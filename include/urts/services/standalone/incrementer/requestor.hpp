#ifndef URTS_SERVICES_STANDALONE_INCREMENTER_REQUESTOR_HPP
#define URTS_SERVICES_STANDALONE_INCREMENTER_REQUESTOR_HPP
#include <memory>
...
namespace URTS::Services::Standalone::Incrementer
{
/// @class Requestor "requestor.hpp" "urts/services/standalone/incrementer/requestor.hpp"
...
public:
    ...
    //[[nodiscard]] UMPS::Services::ConnectionInformation::SocketDetails::Request getSocketDetails() const;
    /// @}
