#ifndef URTS_SERVICES_STANDALONE_INCREMENTER_ITEMS_RESPONSE_HPP
#define URTS_SERVICES_STANDALONE_INCREMENTER_ITEMS_RESPONSE_HPP
#include <memory>
#include <set>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Standalone::Incrementer
{
/// @class ItemsResponse "itemsResponse.hpp" "urts/services/standalone/incrementer/itemsResponse.hpp"
