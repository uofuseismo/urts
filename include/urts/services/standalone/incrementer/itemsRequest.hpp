#ifndef URTS_SERVICES_STANDALONE_INCREMENTER_ITEMS_REQUEST_HPP
#define URTS_SERVICES_STANDALONE_INCREMENTER_ITEMS_REQUEST_HPP
#include <memory>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Standalone::Incrementer
{
/// @class ItemsRequest "itemsRequest.hpp" "urts/services/standalone/incrementer/itemRequest.hpp"
