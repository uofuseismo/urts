#ifndef URTS_SERVICES_SCALABLE_DETECTORS_UNET_THREE_COMPONENT_S_INFERENCE_RESPONSE_HPP
#define URTS_SERVICES_SCALABLE_DETECTORS_UNET_THREE_COMPONENT_S_INFERENCE_RESPONSE_HPP
#include <memory>
#include <vector>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Scalable::Detectors::UNetThreeComponentS
{
/// @class InferenceResponse "inferenceResponse.hpp" "urts/services/scalable/detectors/uNetThreeComponentS/inferenceResponse.hpp"
/// @brief The probability of each sample in a processed three-component signal
///        being an S arrival or noise.
