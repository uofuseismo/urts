#ifndef URTS_SERVICES_SCALABLE_DETECTORS_UNET_ONE_COMPONENT_P_PROCESSING_RESPONSE_HPP
#define URTS_SERVICES_SCALABLE_DETECTORS_UNET_ONE_COMPONENT_P_PROCESSING_RESPONSE_HPP
#include <memory>
#include <vector>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Scalable::Detectors::UNetOneComponentP
{
/// @class ProcessingResponse "processingResponse.hpp" "urts/services/scalable/detectors/uNetOneComponentP/processingResponse.hpp"
/// @brief The probability of each sample in an unprocessed single-channel
