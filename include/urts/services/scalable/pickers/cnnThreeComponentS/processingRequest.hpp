#ifndef URTS_SERVICES_SCALABLE_PICKERS_CNN_THREE_COMPONENT_S_PROCESSING_REQUEST_HPP
#define URTS_SERVICES_SCALABLE_PICKERS_CNN_THREE_COMPONENT_S_PROCESSING_REQUEST_HPP
#include <memory>
#include <vector>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Scalable::Pickers::CNNThreeComponentS
{
/// @class ProcessingRequest "processingRequest.hpp" "urts/services/scalable/pickers/cnnThreeComponentS/processingRequest.hpp"
/// @brief Requests a snippet be preprocessed then inference be performed.
///        It is assumed that the initial S pick is near the center of the
///        window.
...
public:
    ...
    ///         or empty.  If the sampling rate is 100 Hz then the signal
    ///         length should equal \c getMinimumSignalLength().
    ...
    /// @result The expected signal length assuming a sampling rate of 100 Hz. 
