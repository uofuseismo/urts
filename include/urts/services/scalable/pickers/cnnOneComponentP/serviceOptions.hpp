#ifndef URTS_SERVICES_SCALABLE_PICKERS_CNN_ONE_COMPONENT_P_SERVICE_OPTIONS_HPP
#define URTS_SERVICES_SCALABLE_PICKERS_CNN_ONE_COMPONENT_P_SERVICE_OPTIONS_HPP
#include <memory>
#include <chrono>
