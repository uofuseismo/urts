#ifndef UMPS_SERVICES_SCALABLE_LOCATORS_ULOCATOR_REQUESTOR_OPTIONS_HPP
#define UMPS_SERVICES_SCALABLE_LOCATORS_ULOCATOR_REQUESTOR_OPTIONS_HPP
#include <memory>
#include <chrono>
...
{
/// @class RequestorOptions "requestorOptions.hpp" "urts/services/scalable/locators/uLocator/requestorOptions.hpp"
/// @brief Defines the options for the location requestor.
