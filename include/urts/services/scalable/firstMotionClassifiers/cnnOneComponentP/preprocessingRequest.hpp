#ifndef URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_PREPROCESSING_REQUEST_HPP
#define URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_PREPROCESSING_REQUEST_HPP
#include <memory>
#include <vector>
#include <umps/messageFormats/message.hpp>
namespace URTS::Services::Scalable::FirstMotionClassifiers::CNNOneComponentP
{
/// @class PreprocessingRequest "preprocessingRequest.hpp" "urts/services/scalable/firstMotionClassifiers/cnnOneComponentP/preprocessingRequest.hpp"
/// @brief Requests a waveform snippet be preprocessed.  It is assumed that
///        the P pick be at the center of this waveform.
...
public:
    ...
    /// @result This class's message type.
