#ifndef URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_SERVICE_HPP
#define URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_SERVICE_HPP
#include <memory>
namespace UMPS
{
 namespace Logging
...
namespace URTS::Services::Scalable::FirstMotionClassifiers::CNNOneComponentP
{
/// @class Service "service.hpp" "urts/services/scalable/detectors/cnnOneComponentP/service.hpp"
/// @brief Runs the CNN P first motion classifier service.
