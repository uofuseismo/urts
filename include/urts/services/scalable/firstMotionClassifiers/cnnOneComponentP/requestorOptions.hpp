#ifndef URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_REQUESTOR_OPTIONS_HPP
#define URTS_SERVICES_SCALABLE_FIRST_MOTION_CLASSIFIERS_CNN_ONE_COMPONENT_P_REQUESTOR_OPTIONS_HPP
#include <memory>
#include <chrono>
...
{
/// @class RequestorOptions "requestorOptions.hpp" "urts/services/scalable/firstMotionClassifiers/cnnOnComponentP/requestorOptions.hpp"
/// @brief Defines the options for the inference service requestor.
...
public:
    ...
    /// @result The receive timeout.  The default is 3 seconds. 
    ...
    /// @result The receive timeout.  The default is 0 seconds.
