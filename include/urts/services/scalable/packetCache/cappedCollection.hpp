...
{
/// @class CappedCollection "cappedCollection.hpp" "urts/services/scalable/packetCache/cappedCollection.hpp"
/// @brief This is a thread-safe fixed-size collection of data packets for a
