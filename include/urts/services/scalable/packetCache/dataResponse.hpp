#ifndef URTS_SERVICES_SCALABLE_PACKET_CACHE_DATA_RESPONSE_HPP
#define URTS_SERVICES_SCALABLE_PACKET_CACHE_DATA_RESPONSE_HPP
#include <memory>
#include <vector>
...
{
public:
    /// @brief Defines the return code for a data request.
    enum ReturnCode
    {
