#ifndef URTS_BROADCASTS_EXTERNAL_SEEDLINK_STREAM_SELECTOR_HPP
#define URTS_BROADCASTS_EXTERNAL_SEEDLINK_STREAM_SELECTOR_HPP
#include <chrono>
#include <memory>
namespace URTS::Broadcasts::External::SEEDLink
{
/// @class StreamSelector "streamSelector.hpp" "urts/broadcasts/external/seedlink/streamSelector.hpp"
