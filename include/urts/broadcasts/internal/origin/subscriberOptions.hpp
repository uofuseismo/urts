#ifndef URTS_BROADCASTS_INTERNAL_ORIGIN_SUBSCRIBER_OPTIONS_HPP
#define URTS_BROADCASTS_INTERNAL_ORIGIN_SUBSCRIBER_OPTIONS_HPP
#include <memory>
#include <chrono>
...
{
/// @class SubscriberOptions "subscriberOptions.hpp" "urts/broadcasts/internal/origin/subscriberOptions.hpp"
/// @brief Defines the parameters for connecting to the origin publication.
