#ifndef URTS_BROADCASTS_INTERNAL_ORIGINS_PUBLISHER_OPTIONS_HPP
#define URTS_BROADCASTS_INTERNAL_ORIGINS_PUBLISHER_OPTIONS_HPP
#include <memory>
#include <string>
#include <chrono>
...
{
/// @class PublisherOptions "publisherOptions.hpp" "urts/broadcasts/internal/origin/publisherOptions.hpp"
/// @brief Options for initializing the publisher in the origin broadcast.
