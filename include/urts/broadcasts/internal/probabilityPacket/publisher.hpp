#ifndef URTS_BROADCASTS_INTERNAL_PROBABILITY_PACKET_PUBLISHER_HPP
#define URTS_BROADCASTS_INTERNAL_PROBABILITY_PACKET_PUBLISHER_HPP
#include <memory>
...
namespace URTS::Broadcasts::Internal::ProbabilityPacket
{
/// @class Publisher "publisher.hpp" "urts/broadcasts/internal/probabilityPacket/publisher.hpp"
/// @brief A publisher specialized for sending probability packets that are
///        generated by ML phase detectors.
...
public:
    ...
    void send(const ProbabilityPacket &message);
