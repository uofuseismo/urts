#ifndef URTS_BROADCASTS_INTERNAL_PROBABILITY_PACKET_SUBSCRIBER_OPTIONS_HPP
#define URTS_BROADCASTS_INTERNAL_PROBABILITY_PACKET_SUBSCRIBER_OPTIONS_HPP
#include <memory>
#include <chrono>
...
{
/// @class SubscriberOptions "subscriberOptions.hpp" "urts/broadcasts/internal/probabilityPacket/subscriberOptions.hpp"
/// @brief Defines the parameters for connecting to the probability
///        packet backend.
