#ifndef URTS_PYTHON_BROADCASTS_INTERNAL_DATA_PACKET_HPP
#define URTS_PYTHON_BROADCASTS_INTERNAL_DATA_PACKET_HPP
#include <memory>
#include <vector>
...
namespace URTS::Python::Broadcasts::Internal::DataPacket
{
/// @class DataPacket
...
public:
    ...
    DataPacket(const URTS::Broadcasts::Internal::DataPacket::DataPacket &packet);
    DataPacket(DataPacket &&packet) noexcept;
    DataPacket& operator=(const DataPacket &packet);
    DataPacket& operator=(const URTS::Broadcasts::Internal::DataPacket::DataPacket &packet);
    DataPacket& operator=(DataPacket &&packet) noexcept;
    [[nodiscard]] const URTS::Broadcasts::Internal::DataPacket::DataPacket& getNativeClassReference() const noexcept;
    [[nodiscard]] URTS::Broadcasts::Internal::DataPacket::DataPacket getNativeClass() const noexcept;
    ...
    ~DataPacket() override;
private:
    std::unique_ptr<URTS::Broadcasts::Internal::DataPacket::DataPacket> pImpl{nullptr};
};
...
public:
    ...
    ~Publisher();
//private:
    std::unique_ptr<URTS::Broadcasts::Internal::DataPacket::Publisher> mPublisher{nullptr};
};
...
public:
    ...
    ~Subscriber();
private:
    std::unique_ptr<URTS::Broadcasts::Internal::DataPacket::Subscriber> mSubscriber{nullptr};
};
/// Initialize
