#ifndef URTS_PYTHON_PROXY_BROADCASTS_DATA_PACKET_HPP
#define URTS_PYTHON_PROXY_BROADCASTS_DATA_PACKET_HPP
#include <memory>
#include <vector>
...
namespace URTS::Python::ProxyBroadcasts::DataPacket
{
/// @class DataPacket
