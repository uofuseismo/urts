...
TEST(ServicesScalableDetectorsUNetThreeComponentS, PreprocessingRequest)
{
    ...
    EXPECT_EQ(request.getMessageType(),
              "URTS::Services::Scalable::Detectors::UNetThreeComponentS::PreprocessingRequest");
}

TEST(ServicesScalableDetectorsUNetThreeComponentS, PreprocessingResponse)
{
    const std::vector<double> vertical{1, 2, 3, 4, 5};
    const std::vector<double> north{6, 7, 8, 9, 10};
    const std::vector<double> east{11, 12, 13, 14, 15};
    ...
    EXPECT_EQ(response.getMessageType(),
              "URTS::Services::Scalable::Detectors::UNetThreeComponentS::PreprocessingResponse");
    EXPECT_FALSE(response.haveReturnCode());
}

TEST(ServicesScalableDetectorsUNetThreeComponentS, InferenceRequest)
{
    ...
    EXPECT_EQ(request.getIdentifier(), 0);
    EXPECT_EQ(request.getMessageType(),
              "URTS::Services::Scalable::Detectors::UNetThreeComponentS::InferenceRequest");
}
                                                                                              

TEST(ServicesScalableDetectorsUNetThreeComponentS, InferenceResponse)
{
    ...
    EXPECT_EQ(response.getIdentifier(), 0); 
    EXPECT_EQ(response.getMessageType(),
              "URTS::Services::Scalable::Detectors::UNetThreeComponentS::InferenceResponse");
    EXPECT_FALSE(response.haveReturnCode());
}


TEST(ServicesScalableDetectorsUNetThreeComponentS, ProcessingRequest)
{
...
TEST(ServicesScalableDetectorsUNetThreeComponentS, ProcessingResponse)
{
    const std::vector<double> probabilitySignal{1, 2, 3, 4, 5}; 
    ...
    EXPECT_EQ(response.getIdentifier(), 0); 
    EXPECT_EQ(response.getMessageType(),
              "URTS::Services::Scalable::Detectors::UNetThreeComponentS::ProcessingResponse");
    EXPECT_FALSE(response.haveReturnCode());
}

TEST(ServicesScalableDetectorsUNetThreeComponentS, ServiceOptions)
{
...
TEST(ServicesScalableDetectorsUNetThreeComponentS, RequestorOptions)
{
    const std::string address{"tcp://127.0.0.1:5550"};
    const int sendHWM{105};
    const int recvHWM{106};
...
const std::string weightsFile{
    "/usr/local/share/UUSSMLModels/detectorsUNetThreeComponentS.onnx"
}; 
...
TEST(ServicesScalableDetectorsUNetThreeComponentS, Service)
{
    // Do this manually
    {
        UUSSMLModels::Detectors::UNetThreeComponentS::Preprocessing
             preprocessing;
        UUSSMLModels::Detectors::UNetThreeComponentS::Inference inference;
